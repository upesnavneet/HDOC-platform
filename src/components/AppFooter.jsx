  ...
  return (
    <footer className="footer-container">
      <div className="footer-chapter-links" style={{ gap: '1rem' }}>
        <a href="https://upesacm.org/" target="_blank" rel="noreferrer" className="footer-btn">UPES ACM</a>
        <a href="https://www.upesacmw.org/" target="_blank" rel="noreferrer" className="footer-btn">UPES ACM-W</a>
      </div>

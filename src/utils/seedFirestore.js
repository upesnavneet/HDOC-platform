...
const seedQuestions = [
  ...
  },
  {
    ...
    descCustom: "Implement Floyd's Cycle-Finding Algorithm to detect if a given singly linked list contains a cycle. Space Complexity O(1).",
    difficulty: 'Easy',
    isMaster: false,
  ...
  },
  {
    ...
    descLc: "Given the root of a binary tree, return the level order traversal of its nodes' values.",
  ...
  },
  {
    ...
    descCustom: 'Given two strings text1 and text2, return the length of their longest common subsequence.',
    difficulty: 'Medium',
    isMaster: false,
  ...
  },
  {
    ...
    descLc: 'There are numCourses courses to take with prerequisites. Return true if you can finish all courses.',
  ...
  },
  {
    ...
    descLc: 'A trie or prefix tree is a tree data structure used to efficiently store and retrieve keys in a dataset of strings.',
    titleCustom: 'Word Search II',
    descCustom: 'Given an m x n board of characters and a list of strings words, return all words on the board using a Trie.',
    difficulty: 'Hard',
    isMaster: false,
  ...
  },
  {
    ...
    descCustom: 'Given two sorted arrays nums1 and nums2, return the median. Time complexity must be O(log(m+n)).',
    difficulty: 'Hard',
    isMaster: true,
    handout: '',
    solutionCode: ''
...
const seedDebuggingChallenges = [
  ...
  },
  {
    ...
    description: 'Identify the deadlock scenario in the thread synchronization. Fix the locking order.',
